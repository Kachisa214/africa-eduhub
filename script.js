...
const resources = [
...
];// ... (rest of your existing resources) ...
    {
        ...
        description: 'Free online courses from leading universities and scholars worldwide.',
        url: 'https://academicearth.org/courses/free/',
        category: 'Various',
        level: 'All Levels',
        tags: ['online course', 'university', 'lectures', 'free']
    },
    {
        id: 'res10',
    ...
    {
        id: 'res11',
        title: 'Saylor Academy: Free College Courses',
        description: 'Self-paced, free online courses for college credit or professional development.',
        url: 'https://www.saylor.org/courses/',
        category: 'Higher Education',
        level: 'Intermediate',
        tags: ['college credit', 'professional development', 'free', 'online course']
    }
    // Add many more here!
];
